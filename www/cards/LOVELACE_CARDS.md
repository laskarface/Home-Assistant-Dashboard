...
button_card_templates:
  ...
  weather_forecast_row:
    ...
    show_name: false
    custom_fields:
      day: "[[[\n  return states['weather.cerny'].attributes.forecast[variables.index].datetime\n\
        \    ? new Date(states['weather.cerny'].attributes.forecast[variables.index].datetime).toLocaleDateString('fr-FR',\
        \ { weekday: 'short' })\n    : '-';\n]]]\n"
      icon: "[[[\n  return states['weather.cerny'].attributes.forecast[variables.index].condition;\n\
        ]]]\n"
      temp_min: "[[[\n  return Math.round(states['weather.cerny'].attributes.forecast[variables.index].templow)\
        \ + \"°C\";\n]]]\n"
      temp_max: "[[[\n  return Math.round(states['weather.cerny'].attributes.forecast[variables.index].temperature)\
        \ + \"°C\";\n]]]\n"
      bar: "[[[\n  const f = states['weather.cerny'].attributes.forecast;\n  const\
  ...
  head:
    ...
    custom_fields:
      ...
      details: "[[[\n  const is_home = variables.is_home;\n  const color = is_home\
        ...
        \    return '#3DDBB8';\n  };\n\n  const a_pic = states['person.User 2']?.attributes.entity_picture;\n\
        \  const c_pic = states['person.User 1']?.attributes.entity_picture;\n  const\
        ...
        card:
          ...
          - type: custom:button-card
            ...
            name: "[[[\n  // --- RESPONSIVE ---\n  const isMobile = window.innerWidth\
              ...
              \ isLearning);\n  \n  const avatar = states['person.User 2']?.attributes.entity_picture;\n\
          ...
          - type: custom:button-card
            ...
            name: "[[[\n  // --- RESPONSIVE ---\n  const isMobile = window.innerWidth\
              ...
              \    return `${Math.round(val)} min`;\n  };\n\n  const avg7d_display\
              \ = getStatDisplay(avg_sid, isLearning);\n  const s1_display = getStatDisplay(s1_sid,\
              \ isLearning);\n  \n  const avatar = states['person.User 1']?.attributes.entity_picture;\n\
              \  const avatar_html = avatar \n    ? `<img src=\"${avatar}\" style=\"\
              width: ${carSize}; height: ${carSize}; border-radius: 50%; border: 2px\
              \ solid ${statusColor}; flex-shrink: 0; filter: drop-shadow(0 0 5px\
              \ ${statusColor}80);\" />`\n    : `<ha-icon icon=\"mdi:car\" style=\"\
  ...
  head:
    ...
    custom_fields:
      img: "[[[\n  if (!entity) return '...';\n  const state = entity.state;\n  const\
        ...
        \ { detail: { entityId: 'weather.cerny' }, bubbles: true, composed: true });\
...
- type: custom:fold-entity-row
  ...
  head:
    type: custom:button-card
    entity: calendar.User 1_User_gmail_com
    show_name: false
    show_icon: false
    tap_action:
      action: none
...
card_mod:
  style: "ha-card {\n  background: transparent !important;\n  box-shadow: none !important;\n\
    ...
    \ in eid or 'signal' in eid or 'ecojoko' in eid or 'cerny' in eid or 'oil' in\
    \ eid or 'diffus' in eid)\n                and not ('battery' in name or 'voltage'\
    \ in name or 'signal' in name or 'ecojoko' in name or 'cerny' in name or 'oil'\
...
- type: custom:fold-entity-row
  ...
  head:
    ...
    custom_fields:
      ...
      details: "[[[\n  let count = 0;\n  const exclusions = /battery|voltage|signal|ecojoko|cerny|oil|diffus/;\n\
...
styles:
  ...
  custom_fields:
    ...
    - color: rgba(255, 255, 255, 0.6)
custom_fields:
  uptime: "[[[\n  const uptime = states['sensor.User 1nas_uptime'].state;\n  return\
  ...
  temp: "[[[\n  const stemp = states['sensor.User 1nas_temperature_du_systeme'].state;\n\
